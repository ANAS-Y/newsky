...
<h4 style="text-align: center; font-family: fantasy;color:#6A58AE ;">Password Recovery</h4>
</div>
...
<div class="form-row mb-3">
    ...
    <div class="form-row">
    <button type="submit" class="btn login-btn mb-3" style="color: white; background-color:#6A58AE;">Recover Password</button>
    </div>
    
     <div class="form-row">
    <div class="col" style="margin-left: 40%;color:blue;">
     <span class="psw">Back to <a href="login" style="color:red;"> login page</a></span>
    </div>
    </div>
